...
// de Suspense lo convertiría en un 200 con esqueleto. Ver components/marca/esqueleto.tsx.

export const metadata: Metadata = {
  title: 'Proyección',
  // El token es la llave de esta pantalla. No puede acabar en un buscador.
  ...
  return (
    <div className="relative bg-background">
      {/*
        ...
        flojo, el claro se lee mejor. Quien presenta sabe cuál es su caso, así
        que el botón se queda a la mano y la decisión es suya.
      */}
