...
export function EnviarCalendario({
  ...
  return (
    <Desplegable
      etiqueta="Mandar las fechas por correo"
      variante="contorno"
      icono="ninguno"
      nombre={nombre}
      abierto={Boolean(estadoPrueba.error || estadoPrueba.aviso)}
    >
      <div className="flex flex-col gap-3">
        <p className="text-sm text-muted-foreground">
          Las {sesionesFuturas} sesiones futuras con botones para agregarlas a Google Calendar, Outlook o
          .ics, y la liga de acceso para quien todavía no ha entrado. Manda primero una prueba a tu correo.
        </p>
        ...
        <div>
          <ConfirmarConModal
            ...
            boton={{
              texto: `Mandar a los ${inscritos} inscritos`,
              etiquetaAccesible: 'Mandar las fechas a todos los inscritos',
              variante: 'outline',
              tamano: 'default',
            }}
          ...
          >
            <p>
              ...
              calendario. Sale en lote, en segundos.
            </p>
          </ConfirmarConModal>
        </div>
      </div>
